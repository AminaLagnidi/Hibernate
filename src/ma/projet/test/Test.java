...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        Homme h1 = new Homme("SALE", "SAAD", "04874884", "dado", new Date(1964 - 1900, 4, 3));
        Homme h2 = new Homme("hnome 1", "hprenome 1", "04874884", "fgfd", new Date(2004 - 1900, 4, 3));
        Homme h3 = new Homme("hnome 2", "hprenome 2", "04874884", "fdfe", new Date(1999 - 1900, 4, 3));
        Homme h4 = new Homme("hnome 3", "hprenome 3", "04874884", "fgfd", new Date(1995 - 1900, 4, 3));
